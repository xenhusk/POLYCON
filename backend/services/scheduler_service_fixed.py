...
class AppointmentScheduler:
    ...
    def _check_and_send_reminders(self):
        ...
        try:
            ...
            # Check for appointments starting within reminder_minutes + 2 extra minutes
            ...
            logger.info(f"Checking reminders at {now.isoformat()}: Found {len(upcoming_appointments)} appointments to check")
