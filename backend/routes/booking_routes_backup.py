...
def create_booking():
    ...
    try:
        ...
        try:
            # Get teacher and student names for notification
            ...
            print(f"Failed to emit socket notification: {str(e)}")
...
def cancel_booking():
    ...
    try:
        ...
        # Emit socket notification for booking cancellation
        try:
            # Get teacher and student names for notification
...
def confirm_booking():
    ...
    try:
        ...
        # Emit socket notification for booking confirmation
        try:
            # Get teacher and student names for notification
            teacher_user = User.query.filter_by(id_number=booking.teacher_id).first()
            teacher_name = f"{teacher_user.first_name} {teacher_user.last_name}" if teacher_user else "Unknown Teacher"
