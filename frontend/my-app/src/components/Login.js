      ...
      <div className="w-full h-[80vh] flex justify-center items-center font-poppins">
        <form onSubmit={handleSubmit} className="flex flex-col w-full max-w-md sm:max-w-lg md:max-w-xl mx-auto">
          ...
          <div class="relative z-0">
            <input className="block py-1 px-1.5 my-2 mt-3 mx-auto w-[76%] text-base text-gray-900 bg-transparent border-0 border-b-2 border-[#005B98] appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              type="email" placeholder=" " value={email} onChange={(e) => setEmail(e.target.value)} required/>
            <label for="Email" class="absolute text-base px-[13%] peer-focus:px-[16%] text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">
              Email</label>
          </div>
          <div class="relative z-0">
            <input className="block py-1 px-1.5 my-2 mt-3 mx-auto w-[76%] text-base text-gray-900 bg-transparent border-0 border-b-2 border-[#005B98] appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              type="password" placeholder=" " value={password} onChange={(e) => setPassword(e.target.value)} required/>
            <label for="Password" class="absolute text-base px-[13%] peer-focus:px-[16%] text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">
              Passowrd</label>
          </div>
            <div className="h-[5%]">
              {message && <p className="text-center text-red-500 text-base">{message}</p>}
            </div>
          <button type="submit" className="bg-[#057DCD] text-white w-[76%] h-[44.59px] rounded-lg my-2 mx-auto shadow-md hover:bg-[#54BEFF]">
            Login
          </button>
