...
export default function AdminPortal() {
  ...
  return (
    <div className="w-full mx-auto">
      <header className="justify-between items-center mb-2">
        <h2 className="text-2xl font-bold text-center py-10 text-gray-800">Manage Users</h2>
      </header>
        ...
        <div className="w-[95%] h-[10vh]">
          <div className="flex flex-row bg-white shadow-md p-1 rounded-lg justify-center items-center">
            <input
              ...
              className="w-[13%] border border-gray-300 rounded-lg px-2 py-2 m-1"
            />
            <input
            ...
            <input
              ...
              className="w-[20%] border border-gray-300 rounded-lg px-2 py-2 m-1"
            />
            <select
              value={role}
              onChange={(e) => setRole(e.target.value)}
              className="w-[12%] border border-gray-300 rounded-lg px-2 py-2 m-1"
            >
