...
{/* <svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12 4.5V19.5M4.75 12H19.25" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg> */}
...
const EnrollmentPopup = () => {
  ...
  // Return null if not faculty or on session page
  if (userRole !== 'faculty' || location.pathname.includes('/session')) {
    return null;
  }
