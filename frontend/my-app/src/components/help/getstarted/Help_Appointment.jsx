  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                  ...
                  <p className="text-gray-600">
                    Easily view all your scheduled future consultations with
                ...
                <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                  ...
                  <p className="text-gray-600">
                    Check details for each appointment, including teacher, time,
                ...
                <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                  ...
                  <p className="text-gray-600">
                    Review your previous consultations and keep a record of your
                ...
                <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                  ...
                  <p className="text-gray-600">
                    Reload the page if appointments do not appear or if you need
        ...
        {/* Teacher Section */}
        { isTeacher && (
          <div className="p-4 sm:p-6 lg:p-8 bg-gradient-to-r from-[#e6f3ff] to-[#fafdff] border-t border-[#54BEFF]">
            <div className="mb-4">
            ...
            <h3 className="text-lg sm:text-2xl font-bold text-[#057DCD] mb-4">
              Appointment Management for Teachers
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">
                ...
                <p className="text-gray-600">
                  Review student appointment requests and approve or decline
                  them directly from your dashboard.
                </p>
              </div>
              <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">
                ...
                <p className="text-gray-600">
                  See a consolidated list of all upcoming and past appointments
                  with students.
                </p>
              </div>
              <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                ...
                <p className="text-gray-600">
                  Notify students about upcoming appointments or changes to the
                  schedule.
                </p>
              </div>
              <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                ...
                <p className="text-gray-600">
                  Organize and manage group consultations, track attendance, and
                  communicate with all participants.
                </p>
              </div>
            </div>
            <div className="mt-6 bg-white rounded-lg p-4 sm:p-6 border-l-4 border-[#00A3FF]">
              ...
              <ul className="list-disc ml-6 text-gray-700">
                ...
                <li>
                  Communicate clearly with students about expectations and
                  required materials.
                </li>
                <li>
        ...
        <div className="p-4 sm:p-6 lg:p-8 bg-gray-50">
          ...
          >
            ...
            <ul className="list-disc ml-6 text-gray-700">
              ...
              <li>
                Contact your teacher if you need to reschedule or cancel an
                appointment.
              </li>
              <li>
                Use the refresh button or reload the page to get the latest
                updates.
              </li>
            </ul>
          </div>
