      ...
      >
        ...
        <div className="bg-gradient-to-r from-[#0056a6] to-[#00a3ff] rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-blue-50 text-sm sm:text-base">
            Follow this guide to set up your account and gain access to the
            POLYCON consultation booking platform
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start space-x-4 relative">
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 mb-4">
                  Click the "Sign Up" link on the login page or navigate
                  directly to the registration URL provided by your institution.
                </p>
            ...
            <div className="flex items-start space-x-4" id="academic-info">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  You need to provide your academic information to ensure you
                  are matched with the right consultants.
                </p>
            ...
            <div className="flex items-start space-x-4" id="email-verification">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  After completing the registration form, click the Submit
                  button and you'll receive a verification email at your
                  ...
                  <div className="p-4 bg-blue-50">
                    <div className="bg-white p-3 rounded-md border border-blue-100 mb-4 shadow-sm">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <button className="text-sm text-[#0056a6] hover:text-[#0078e7] hover:underline">
                          Resend email
                        </button>
                      </div>
                    </div>
        ...
        >
          ...
          <div className="space-y-6">
            <p className="text-gray-700">
              ...
              institutional email account and helps protect your POLYCON
              account.
            </p>
              ...
              <div className="border rounded-lg overflow-hidden shadow-sm bg-white">
                <div className="bg-gradient-to-r from-[#e6f3ff] to-[#f0f7ff] px-4 py-3 border-b">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="bg-[#0056a6] text-white rounded-full w-6 h-6 flex items-center justify-center mr-2">
                        1
                      </div>
                      <h4 className="font-medium text-[#0056a6]">
                        Receive Email
                  ...
                  <div className="border border-gray-200 rounded p-3 bg-gray-50 flex items-center mb-3">
                    ...
                    <div className="text-xs">
                      ...
                      <p className="text-gray-500">
                        From: notifications@polycon.edu
                      </p>
                    </div>
                  </div>
                  <p className="text-sm text-gray-600">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-2 text-sm text-yellow-700">
                    If you don't receive the verification email within 15
                    minutes:
                  </p>
        ...
        >
          ...
          <div className="space-y-6">
              ...
              <div className="p-5 bg-white">
                <div className="mb-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    ...
                    activated. You now have full access to the platform
                    features.
                  </p>
                </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-700">
                    <strong>Account Status:</strong> Your account status will
                    show as "Verified" on your profile. A green verification
                    badge will appear next to your name throughout the platform.
                  </p>
                </div>
              </div>
            </div>
            ...
            <p className="text-gray-700">
              You'll also receive a welcome email with additional information
              about getting started with POLYCON, including links to helpful
