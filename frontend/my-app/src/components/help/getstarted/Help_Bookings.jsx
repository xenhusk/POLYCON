    ...
    >
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="p-4 sm:p-6 lg:p-8 border-b border-gray-200">
          <div className="mb-2">
            <span className="text-sm text-[#057DCD] font-medium">Booking Consultations</span>
          </div>
        ...
        <div className="p-4 sm:p-6 lg:p-8" id="booking_features">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
              <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Teacher Search</h4>
            ...
            {/* Feature 2 */}
            <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
              <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Available Time Slots</h4>
              <p className="text-gray-600">
            ...
            {/* Feature 3 */}
            <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
              <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Group Consultations</h4>
              <p className="text-gray-600">
            ...
            {/* Feature 4 */}
            <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
              <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Confirmation & Reminders</h4>
              <p className="text-gray-600">
        ...
        <div className="p-4 sm:p-6 lg:p-8 bg-gray-50">
          <div className="bg-white rounded-lg p-4 sm:p-6 border-l-4 border-[#057DCD]" id="tips_section_bookings">
            <h4 className="font-semibold text-[#057DCD] mb-2">Tips for Booking</h4>
            <ul className="list-disc ml-6 text-gray-700">
              <li>Book early to secure your preferred time slot.</li>
              <li>Double-check the time zone of your booking.</li>
              <li>Communicate with your teacher about any specific topics or questions you have.</li>
              <li>Keep your software updated for the best virtual consultation experience.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-6 lg:p-8 border-t border-gray-200">
          <h3 className="text-lg sm:text-2xl font-bold text-gray-900 mb-4">Ready to Book a Consultation?</h3>
          <p className="text-base sm:text-lg text-gray-600 mb-4 sm:mb-6">
