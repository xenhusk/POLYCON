            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6 auto-rows-auto sm:grid-cols-[repeat(auto-fit,minmax(250px,1fr))] md:grid-cols-2">
              ...
              <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Instantly view your name, program, year/section, and other
                  personal details.
                </p>
              </div>
              {/* Feature 2 */}
              <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  See all your scheduled and upcoming consultations in a
                  calendar view.
                </p>
              </div>
              {/* Feature 3 */}
              <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Book a new consultation, view your appointments, or update
                  your profile with just a click.
                </p>
              </div>
              {/* Feature 4 */}
              <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border border-blue-200">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Stay updated with reminders and important announcements from
                  faculty.
                </p>
              </div>
            </div>
          ...
          <div className="p-4 sm:p-6 lg:p-8 bg-gray-50">
            ...
            >
              ...
              <ul className="list-disc ml-6 text-sm sm:text-base text-gray-700">
                <li>
                  Check your dashboard regularly to stay on top of your academic
                  schedule.
                </li>
                <li>
                  Use the “View My Appointments” button on mobile for a
                  streamlined experience.
                </li>
                <li>
                  Update your profile to ensure your information is always
                  current.
                </li>
              </ul>
            </div>
      ...
      { isTeacher && (
        <div className="bg-white rounded-lg shadow-sm border border-[#54BEFF] max-w-7xl mx-auto">
          ...
          <div className="p-4 sm:p-6 lg:p-8 border-b border-[#54BEFF] bg-gradient-to-r from-[#e6f3ff] to-[#fafdff]">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-[#057DCD] mb-3 sm:mb-4">
              Your Dashboard Overview
            </h2>
            <p className="text-base sm:text-lg text-gray-700 mb-4 sm:mb-6">
              The dashboard is your central hub for managing consultations, tracking student progress, and communicating with your classes.
            </p>
          </div>

          {/* Feature highlight */}
          <div className="p-4 sm:p-6 lg:p-8 bg-gradient-to-r from-[#54BEFF] to-[#e6f3ff] text-[#057DCD]">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="w-full sm:w-2/3">
                <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">
                ...
                <p className="text-base sm:text-lg opacity-90 mb-4">
                  Access your schedule, manage consultation slots, and monitor student engagement directly from your dashboard.
                </p>
              </div>
              <div className="w-full sm:w-1/3 h-32 sm:h-40 bg-white/30 rounded-lg flex items-center justify-center">
                <div className="text-4xl sm:text-6xl">🧑‍🏫</div>
              </div>
            </div>
          </div>
          ...
          {/* Dashboard Features */}
          <div className="p-4 sm:p-6 lg:p-8" id="dashboard_features">
            <h3 className="text-xl sm:text-2xl font-bold text-[#057DCD] mb-4 sm:mb-6">
